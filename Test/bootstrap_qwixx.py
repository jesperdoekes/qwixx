# bootstrap_qwixx.py
# Creates the qwixx Python package (engine + CLI) and README in the current folder.

from pathlib import Path

INIT_PY = (
    "from .game import QwixxGame, GameError, Phase, GameStatus\n"
    "__all__ = ['QwixxGame', 'GameError', 'Phase', 'GameStatus']\n"
)
...
def main():
    write("qwixx/__init__.py", INIT_PY)
    write("qwixx/game.py", GAME_PY)
    write("qwixx/cli.py", CLI_PY)
